...
require_once 'tools/employee_medical.php';

$obj_to_use = "EmployeeMedical";
...
// require('tools/employee-medicalrecords.php');
// require_once('database/dbtools.php');
// if (!empty($_POST))
// {
// 	$conn = connect();
...
// 		$prescription = (isset($_POST['prescription']) ? strtolower($_POST['prescription']) : NULL);
// 		$hospital     = (isset($_POST['hospital']) ? strtolower($_POST['hospital']) : NULL);
// 		$physician    = (isset($_POST['physician']) ? strtolower($_POST['physician']) : NULL);
// 		$checkup_date = (isset($_POST['checkup_date']) ? strtolower($_POST['checkup_date']) : NULL);
// 		$vac_exp      = (isset($_POST['vac_exp']) ? strtolower($_POST['vac_exp']) : NULL);
...
// 		else
// 		{
// 			$medical = new MedicalRecords($conn, $employee_id, $description, $prescription, $hospital, $physician, $checkup_date, $vac_exp);
// 			switch ($action)
// 			{
// 				case 'add':
...
// 						if ($employee_id != '' && $description != '' && $prescription != '' && $hospital != '' && $physician != '')
// 						{
// 							// insert records
// 							$insertId = $medical->CreateMedical();
// 							$json['code'] = "OK";
...
// 					if ($_SESSION['level'] == 'HR MANAGERS')
// 					{
// 						$medicalList = $medical->viewMedical($keyword, $employee_id);
// 						$json['code'] = "200";
// 						$json['response'] = $medicalList;
// 					}
// 					else
// 					{
// 						$json['code'] = "403";
