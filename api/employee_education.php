...
require_once 'tools/employee_education.php';

$obj_to_use = "EmployeeEducation";
...
// require('tools/employee_education.php');
// require_once('database/dbtools.php');
// if (!empty($_POST))
// {
// 	$conn = connect();
...
// 		$school      = (isset($_POST['school']) ? strtolower($_POST['school']) : NULL);
// 		$level       = (isset($_POST['level']) ? strtolower($_POST['level']) : NULL);
// 		$course      = (isset($_POST['course']) ? strtolower($_POST['course']) : NULL);
// 		$degree      = (isset($_POST['degree']) ? strtolower($_POST['degree']) : NULL);
// 		$honors      = (isset($_POST['honors']) ? strtolower($_POST['honors']) : NULL);
...
// 		else
// 		{
// 			$education = new Education($conn, $employee_id, $school, $level, $course, $degree, $honors);
// 			switch ($action)
// 			{
// 				case 'add':
...
// 						if ($employee_id != '' && $employee_id != '' && $school != '' && $course != '' && $degree != '')
// 						{
// 							// insert records
// 							$insertId = $education->CreateEducation();
// 							$json['code'] = "OK";
...
// 					if ($_SESSION['level'] == 'HR MANAGERS')
// 					{
// 						$educationList = $education->viewEducation($keyword, $employee_id);
// 						$json['code'] = "200";
// 						$json['response'] = $educationList;
// 					}
// 					else
// 					{
// 						$json['code'] = "403";
