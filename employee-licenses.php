...
<?php echo generate_employee_view_header($employee_id, 'Licenses');?>

	<div>LICENSES<br/><br/></div>
<?php
$module = "employee_licenses";
echo generate_view_div($module, array('License Type', 'License No', 'Date Issued', 'Date Expiry', 'Remarks', 'Actions'));

echo generate_add_div($module, array(
        array('license_type', 'License Type*', 'text'),
        array('license_no', 'License No*', 'text'),
        array('date_issued', 'Date Issued*', 'text'),
        array('expiry_date', 'Date Expiry*', 'text'),
        array('remarks', 'Remarks*', 'text')
    ));

echo generate_edit_div($module, array(
        array('license_type', 'License Type*', 'text', false),
        array('license_no', 'License No*', 'text', false),
        array('date_issued', 'Date Issued*', 'text', false),
        array('expiry_date', 'Date Expiry*', 'text', false),
...
?>
	...
	<div id="view-license">
		...
		<div class="right">
        <input type="button" class="tbl-main-action-btn" id="add_license" value="Add New" />
		</div>
		<div>&nbsp;</div>
		<table>
			<thead>
...
<script type="text/javascript" src="js/employee-license2.js"></script>
